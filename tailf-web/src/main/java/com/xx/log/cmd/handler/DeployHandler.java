...
import com.xx.log.config.properties.DeployProperties;
    ...
    public void handleMessage(BaseParam baseParam) {
        ...
        ThreadPoolUtil.submit(() -> {
                    ...
                    try {
                        ...
                        //  获得安装包位置，上传文件
                        String localFilePath = this.deployProperties.getAttachmentFilepath() + this.deployProperties.getAttachmentFileName();
